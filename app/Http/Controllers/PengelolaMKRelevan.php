...
class PengelolaMKRelevan extends Controller
{
    public function detail($slug)
    {
        ...
        $responseDetail = Http::withToken($token)->get('https://devskripsi.com/api/student/detail');
        ...
        $firebaseURL = "https://firestore.googleapis.com/v1/projects/career-apps/databases/(default)/documents/mata-kuliah/kurikulum-2020/tif-2020-wajib/{$slug}";

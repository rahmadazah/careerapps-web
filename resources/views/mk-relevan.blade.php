...
@section('content')
    ...
    <div class="w-full flex flex-col items-start gap-4">
        <div class="w-full p-3 bg-white rounded-lg border border-gray-200 flex items-start flex-col gap-1">
            ...
            <div class="text-[#073B60] text-base font-normal leading-snug">{{ $detail['deskripsi'] }}</div>
        </div>
        <div class="w-full p-3 bg-white rounded-lg border border-gray-200 flex items-start flex-col gap-1">
            <div class="text-[#073B60] text-base font-bold leading-snug">Capaian Pembelajaran Mata Kuliah</div>
            <div class="text-[#073B60] text-base font-normal leading-snug">{{ $detail['cpmk'] }}</div>
        </div>
        <div class="w-full p-3 bg-white rounded-lg border border-gray-200 flex items-start flex-col gap-1">
            <div class="text-[#073B60] text-base font-bold leading-snug">Sub Capaian Pembelajaran Mata Kuliah</div>
            <div class="text-[#073B60] text-base font-normal leading-snug">{{ $detail['subcpmk'] }}</div>
        </div>
    </div>
@endsection
